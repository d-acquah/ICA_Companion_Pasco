...
void showTopicsLockedDialog(BuildContext context) {
  showDialog(
    context: context,
              ...
              child: Container(
                ...
                child: AlertDialog(
                  ...
                  content: SingleChildScrollView(
                    child: Text(
                      'This feature categorizes past questions according to the topics they fall under and is available to premium users only.',
                      style: TextStyle(
                        color: Colors.white,
                        fontSize: 18,
